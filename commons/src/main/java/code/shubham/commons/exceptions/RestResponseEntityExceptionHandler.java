...
public class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<?> handleAccessDeniedException(
        ...
        return ResponseUtils.getErrorResponseEntity(
                HttpStatus.FORBIDDEN.value(), "Access denied message here");
    }
    ...
    public ResponseEntity<?> handleAuthorizationClientException(
            AuthorizationClientException exception, WebRequest request) {
        return ResponseUtils.getErrorResponseEntity(
    ...
    public ResponseEntity<?> handleAWSS3BlobStoreException(
            InvalidRequestException exception, WebRequest request) {
        return ResponseUtils.getErrorResponseEntity(
                HttpStatus.BAD_REQUEST.value(), exception.getOriginalErrors());
    }
